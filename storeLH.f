...
* procedure is stricly dependent on the phase-space routine called.
      ...
      if(iphsp.eq.1)then        ! phsp1_1_4
        ...
        if(isresonant(1).eq.1)then ! rm1[a,b]
          ...
          ndaughters=4
          iord_daughters_LH(1) =
     &         index_pythia(iordamp(iorder(3,iphs_ind)))
          iord_daughters_LH(2) =
     &         index_pythia(iordamp(iorder(4,iphs_ind)))
          iord_daughters_LH(3) =
     &         index_pythia(iordamp(iorder(5,iphs_ind)))
          iord_daughters_LH(4) =
     &         index_pythia(iordamp(iorder(6,iphs_ind)))
     ...
     &          isconsistent)
         ...
         if(isresonant(3).eq.1)then ! rm11[a,b,c]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(3,iphs_ind)))
     ...
     &           isconsistent)
         ...
         if(isresonant(4).eq.1)then ! rm12[a,b,c]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(5,iphs_ind)))
     ...
     &          isconsistent)
         ...
         if(isresonant(4).eq.1)then ! rm12[a,b]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(5,iphs_ind)))
     ...
     &          isconsistent)
         ...
         if(isresonant(2).eq.1)then ! rm2[a,b,c]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(7,iphs_ind)))
            iord_daughters_LH(2) =
     &           index_pythia(iordamp(iorder(8,iphs_ind)))
     ...
     &           isconsistent)
      ...
      elseif(iphsp.eq.3)then    ! phsp1_1_31
         ...
         if(isresonant(3).eq.1)then ! rm111[a,b]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(3,iphs_ind)))
...
c end giuseppe 08/09/2007
     ...
     &            isconsistent)
      ...
      elseif(iphsp.eq.4)then    ! phsp1_2_3
         ...
         if(isresonant(4).eq.1)then ! rm11[a,b]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(3,iphs_ind)))
...
c end giuseppe 08/09/2007
     ...
     &              isconsistent)
         ...
         if(isresonant(3).eq.1)then ! rm2[a,b]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(6,iphs_ind)))
...
c end giuseppe 08/09/2007
     ...
     &            isconsistent)
         ...
         if(isresonant(4).eq.1)then ! rm21[a,b]
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(5,iphs_ind)))
...
c end giuseppe 08/09/2007
     ...
     &           isconsistent)
      ...
      elseif(iphsp.eq.7)then    ! phsp1_5to1_4to31
         ...
         if(isresonant(4).eq.1)then ! rm1111
            i_mother=i_mother+1
            ndaughters=2
            iord_daughters_LH(1) =
     &           index_pythia(iordamp(iorder(3,iphs_ind)))
