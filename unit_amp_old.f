...
*four momenta                                                           
      ...
      record/polcom/cewp1,cewm1,cewp2,cewm2
...
*      print*, 'skin2=', skin2                                          
      ...
      cunit= 8d0*(alpha4+vev4/(8d0*skin2)*
     & (cdelta_aij(2,0)-10d0*cdelta_aij(2,2)))*cp1p2lor+
     & 4d0*(alpha4+2d0*alpha5+15d0*vev4/(4d0*skin2)*cdelta_aij(2,2))*
     & (cp1m1lor+cp1m2lor)
...
*four momenta                                                           
      ...
      record/pol/cez1(2,2),cez2(2,2),cez3(2,2),cez4(2,2)
      ...
      structure/three_forks_amp/
       ...
       record/three_forks_amp/cz1z2lor(2,2,2,2,2,2),
...
* minimum "s" for applying corrections to the amplitudes
	 ...
	 enddo
      ...
      cfact1=8d0*(alpha4+alpha5+vev4/(24d0*skin2)*
     & (cdelta_aij(0,0)+2d0*cdelta_aij(2,0))-
     &   5d0*vev4/(12d0*skin2)*
     & (cdelta_aij(0,2)+2d0*cdelta_aij(2,2)))
  
      cfact2=8d0*(alpha4+alpha5+5d0*vev4/(8d0*skin2)*
     &  (cdelta_aij(0,2)+2d0*cdelta_aij(2,2)))
...
*four momenta                                                           
      ...
      record/pol/cez1(2),cez2(2),cez3(2),cez4(2)
...
*four momenta                                                           
      ...
      record/pol/cz1(2,2),cz2(2,2),cwp,cwm
...
* minimum "s" for applying corrections to the amplitudes
	...
	enddo
      ...
      cfact1=8d0*(alpha5+vev4/(24d0*skin2)*
     & (cdelta_aij(0,0)-cdelta_aij(2,0))-
     &   5d0*vev4/(12d0*skin2)*
     & (cdelta_aij(0,2)-cdelta_aij(2,2)))
  
      cfact2=4d0*(alpha4+5d0*vev4/(4d0*skin2)*
     &  (cdelta_aij(0,2)-cdelta_aij(2,2)))
...
* minimum "s" for applying corrections to the amplitudes
	...
	enddo
      ...
      cfact1=4d0*(alpha4+vev4/(8d0*skin2)*cdelta_aij(2,0)
     &   -5d0*vev4/(4d0*skin2)*cdelta_aij(2,2))
  
      cfact2=8d0*(alpha5-3d0*vev4/(16d0*skin2)*cdelta_aij(1,1)
     &  +15d0*vev4/(16d0*skin2)*cdelta_aij(2,2))
  
      cfact3=4d0*(alpha4+3d0*vev4/(8d0*skin2)*cdelta_aij(1,1)
...
*four momenta                                                           
      ...
      record/pol/cz1(2),cz2(2),cwp,cwm
