...
*structure for the two incoming color configurations
      ...
      structure/uno/
         ...
         record/due/ couple(maxcouple)
         record/tre/ triple(maxtriple)
      end structure
      record /uno/ col1,col2
...
*structure for the sum of the triples
      ...
      structure/uno3/
         integer ntriple
         record/tre/ triple(2*maxtriple)
      end structure
      record /uno3/ colthree
...
c         integer ncouple,ntriple
         integer ncouple
         record/duetot/ couple(maxcoupletot)
      end structure
      record /unotot/ col(maxconfigtot)
