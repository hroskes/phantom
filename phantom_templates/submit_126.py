...
#        sys.exit (1) 
    ...
    if args.step == '1' :
        ...
        command = './setupdir2.pl -b /afs/cern.ch/user/g/govoni/work/PHANTOM/phantom_at_cern/phantom_1_2_6'
        if (args.Top != 'none') : 
            command += ' -T ' + args.Top
        ...
        command += '/afs/cern.ch/user/g/govoni/work/PHANTOM/phantom_at_cern/phantom_1_2_6/tools/totint.exe > result '
        print command
        execute (command)
                
        command = 'cd ' + genFolder + '; grep -A 1 total\ integral gen*/run.o* > res ; '
        command += '/afs/cern.ch/user/g/govoni/work/PHANTOM/phantom_at_cern/phantom_1_2_6/tools/gentotint.exe > result '
        print command
        execute (command)
